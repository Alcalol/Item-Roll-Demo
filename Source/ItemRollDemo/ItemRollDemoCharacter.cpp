...
AItemRollDemoCharacter::AItemRollDemoCharacter()
{
...
void AItemRollDemoCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AItemRollDemoCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AItemRollDemoCharacter::Move);
...
void AItemRollDemoCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AItemRollDemoCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
