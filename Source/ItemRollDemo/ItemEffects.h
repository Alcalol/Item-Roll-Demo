...
enum class EItemEffects : uint8
{
	...
	EFFECT_Dexterity_Percent UMETA(DisplayName = "Dexterity Percent"),
	EFFECT_Magic_Value UMETA(DisplayName = "Magic Value"),
	EFFECT_Magic_Percent UMETA(DisplayName = "Magic Percent"),
	EFFECT_Stamina_Value UMETA(DisplayName = "Stamina Value"),
	EFFECT_Stamina_Percent UMETA(DisplayName = "Stamina Percent"),
	EFFECT_Damage_Reduction_Value UMETA(DisplayName = "Damage Reduction Value"),
	EFFECT_Damage_Reduction_Percent UMETA(DisplayName = "Damage Reduction Percent"),
	EFFECT_Armor_Rating_Value UMETA(DisplayName = "Armor Rating Value"),
	EFFECT_Armor_Rating_Percent UMETA(DisplayName = "Armor Rating Percent"),
	EFFECT_Attack_Speed_Value UMETA(DisplayName = "Attack Speed Value"),
	EFFECT_Attack_Speed_Percent UMETA(DisplayName = "Attack Speed Percent"),
};
